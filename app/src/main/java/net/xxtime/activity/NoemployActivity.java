 ...
 *wei录用
 */
public class NoemployActivity extends BaseActivity implements AdapterView.OnItemClickListener{
                ...
                case 1:
                    ...
                    if (jobByConditionBean!=null&&jobByConditionBean.getBflag().equals("1")){
                        if (jobByConditionBean.getDefaultAList()!=null&&jobByConditionBean.getDefaultAList().size()>0) {
                            jobAdapter=new JobAdapter(jobByConditionBean.getDefaultAList(),NoemployActivity.this);
                            lvJobs.setAdapter(jobAdapter);
                            jobAdapter.setStatus("未录用");
    ...
    public void setContentView() {
        setContentView(R.layout.activity_noemploy);
    }
