...
public class MsgSalaryActivity extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 1:
                    ...
                    if (studentUserMsgBean!=null&&studentUserMsgBean.getBflag().equals("1")){
                        if (studentUserMsgBean.getDefaultAList()!=null&&studentUserMsgBean.getDefaultAList().size()>0) {
                            msgFollowAdapter = new MsgFollowAdapter(studentUserMsgBean.getDefaultAList(), MsgSalaryActivity.this);
                ...
                case 2:
                    ...
                    ToastUtils.show(MsgSalaryActivity.this,commonBean.getMsg());
                    break;
            }
        }
    };
    ...
    public void setContentView() {
        setContentView(R.layout.activity_msg_salary);
    }
    ...
    public void setListener() {
        ...
        plFollows.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<ListView>() {
            ...
            public void onRefresh(PullToRefreshBase<ListView> refreshView) {
                String label = DateUtils.formatDateTime(MsgSalaryActivity.this, System.currentTimeMillis(),
