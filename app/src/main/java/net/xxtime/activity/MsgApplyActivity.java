...
public class MsgApplyActivity extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 1:
                    ...
                    if (studentUserMsgBean!=null&&studentUserMsgBean.getBflag().equals("1")){
                        if (studentUserMsgBean.getDefaultAList()!=null&&studentUserMsgBean.getDefaultAList().size()>0) {
                            msgFollowAdapter = new MsgFollowAdapter(studentUserMsgBean.getDefaultAList(), MsgApplyActivity.this);
                ...
                case 2:
                    ...
                    ToastUtils.show(MsgApplyActivity.this,commonBean.getMsg());
                    break;
            }
        }
    };
    ...
    public void setContentView() {
        setContentView(R.layout.activity_msg_apply);
    }
    ...
    public void setListener() {
        ...
        plFollows.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<ListView>() {
            ...
            public void onRefresh(PullToRefreshBase<ListView> refreshView) {
                String label = DateUtils.formatDateTime(MsgApplyActivity.this, System.currentTimeMillis(),
