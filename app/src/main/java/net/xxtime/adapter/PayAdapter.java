...
public class PayAdapter extends BaseAdapter {
    ...
    public PayAdapter(List<String> listDefaults, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) { 
        ...
        if (!StringUtils.isEmpty(listDefaults.get(position))){
            area_item.tv_name.setText(listDefaults.get(position));
        }
