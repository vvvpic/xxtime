...
public class ProvineAdapter extends BaseAdapter {

    private Context context;
    private List<CitysBean.ProvinceBean> listAreas;

    public ProvineAdapter(List<CitysBean.ProvinceBean> listAreas, Context context) {
